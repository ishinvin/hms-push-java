...
#### 1. 发送Android透传消息
代码位置：[examples/SendDataMessage.java](doc/examples/SendDataMessage.java)

#### 2.	发送Android通知栏消息
代码位置：[examples/SendNotifyMessage.java](doc/examples/SendNotifyMessage.java)

#### 3.	基于主题发送消息
代码位置：[examples/SendTopicMessage.java](doc/examples/SendTopicMessage.java)

#### 4.	基于条件发送消息
代码位置：[examples/SendConditionMessage.java](doc/examples/SendConditionMessage.java)

#### 5.	向华为快应用发送消息
代码位置：[examples/SendInstanceAppMessage.java](doc/examples/SendInstanceAppMessage.java)

#### 6.	基于WebPush代理发送消息
代码位置：[examples/SendWebpushMessage.java](doc/examples/SendWebpushMessage.java)

#### 7.	基于APNs代理发送消息
代码位置：[examples/SendApnsMessage.java](doc/examples/SendApnsMessage.java)

#### 8.	发送测试消息
代码位置：[examples/SendTestMessage.java](doc/examples/SendTestMessage.java)
